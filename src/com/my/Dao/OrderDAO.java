...
public class OrderDAO extends BaseHibernateDAO {
	...
	public Order findById(java.lang.Integer id) {
		...
		try {
			Order instance = (Order) getSession().get("com.my.Entity.Order", id);
			return instance;
		} catch (RuntimeException re) {
	...
	public List findByExample(Order instance) {
		...
		try {
			List results = getSession().createCriteria("com.my.Entity.Order")
	...
	public List findByNumofpeople(Object numofpeople) {
		return findByProperty(NUMOFPEOPLE, numofpeople);
	}
